...
<div id="banner-wrapper">
    <div id="banner" class="row">
        <div class="large-8 large-offset-2 columns text-center">
            <span class="banner-text">Web development and design trends are changing at an ever-rapid pace. We want to hear how new paradigms and tools are impacting you and the way you work!</span> <a id="banner-button" href="https://bracketssurvey.typeform.com/to/SyLpAw" class="rounded radius button">Take the 2017 Brackets Survey</a>
        </div>
    </div>
</div>
<!-- -->
        ...
        <div class="large-12 columns">
            ...
            <div id="download">
                <a id="download-plain-brackets" class="large rounded radius button" href="#">
					<div data-i18n="[html]index.page.hero.download">Download Brackets <d id="download-brackets-version">1.8</d></div>
				</a>
